...
const getStocks = async (req, res, next) => {
    try {
        ...
        return res.status(Constants.HTTP_STATUS_CODES.SUCCESS).json(ResponseStandardiser.generateStandardResponse(Constants.APP_STATUS_CODES.SUCCESS, Constants.APP_STATUS_DESCRIPTORS.RESULT_FOUND, stocks));
    }
    catch (err) {
        next(err);
    }
...
const getStock = async (req, res, next) => {
    try {
        ...
        return res.status(Constants.HTTP_STATUS_CODES.SUCCESS).json(ResponseStandardiser.generateStandardResponse(Constants.APP_STATUS_CODES.SUCCESS, Constants.APP_STATUS_DESCRIPTORS.RESULT_FOUND, stock));
    }
    catch (err) {
        next(err);
    }
...
const getTrackedStocks = async (_req, res, next) => {
    try {
...
const trackStock = async (req, res, next) => {
    try {
...
const untrackStock = async (req, res, next) => {
    try {
